 ...
 */
class ResultCollectorDecorator extends MxRunListenerDecorator {

    private final ArrayList<Description> passed;
    private final ArrayList<Failure> failed;

    ResultCollectorDecorator(MxRunListener l) {
        super(l);
    ...
    public List<Description> getPassed() {
        return passed;
    }
}
