...
local with(platform, java_release, timelimit="15:00") = {
    ...
    proftool_test:: self.with_name("proftool-test") + {
        ...
        run: [
            ...
            ["sh", "-c", "printf '%s\n' proftool_fop_* | tail -n 1 | xargs -i mv {} proftool_fop_last"],
            ...
            ["sh", "-c", "printf '%s\n' proftool_tmt_* | tail -n 1 | xargs -i mv {} proftool_tmt_last"],
            ...
            ["sh", "-c", "printf '%s\n' proftool_scrabble_* | tail -n 1 | xargs -i mv {} proftool_scrabble_last"],
